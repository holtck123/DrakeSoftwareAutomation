...
@When("User clicks on the Buy Drake button")
public void User_clicks_on_the_Buy_Drake_button() {
	driver.findElement(By.xpath("//body/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/a[1]")).click();
}
}
